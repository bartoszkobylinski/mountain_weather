...
urlpatterns = [
    ...
    path('zakopane/',
         ZakopaneAreaWeatherForecastView.as_view(), name='Zakopane'),
    path('dolina_chocholowska/',
         DolinaChocholowskaAreaWeatherForecastView.as_view(),
         name='Dolina Chocholowska'),
    path('dolina_koscieliska/',
         DolinaKoscieliskaAreaWeatherForecastView.as_view(),
         name='Dolina Koscieliska'),
    path('dolina_pieciu_stawow/',
         DolinaPieciuStawowAreaWeatherForecastView.as_view(),
         name='Dolina Pieciu Stawow Polskich'),
    path('kasprowy_wierch/',
         KasprowyWierchAreaWeatherForecastView.as_view(),
         name='Kasprowy Wierch'),
    path('morskie_oko/',
         MorskieOkoAreaWeatherForecastView.as_view(),
         name='Morskie Oko'),
    path('lomnica/',
         LomnicaAreaWeatherForecastView.as_view(), name='Lomnica'),
    ...
    path('mieguszowiecki/',
         MieguszowieckiForecastView.as_view(), name='Mieguszowiecki'),
