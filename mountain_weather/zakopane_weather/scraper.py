...
class MountainWeatherScraper:
    ...
    path = "/home/bart/PythonProjects/mountain_weather/mountain_weather/zakopane_weather/chromedriver"
    ...
    def _navigate_to_data_table(self):
        ...
        try:
            ...
            print(str(e) + " that is exception from first try line 64")
        except Exception as e:
    ...
    def make_correction_in_octave(self,octave):
        ...
        print("That is octave " + str(octave))
        try:
            if octave[1] == '0':
                del(octave[2])
            else:
